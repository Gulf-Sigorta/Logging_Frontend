...
const LogLevelSummary = ({ levelCounts, selectedLevel, onLevelSelect }) => {
  ...
  const levelStyleMap = {
    ERROR:
      "border border-red-500 text-red-700 bg-red-100/30 hover:bg-red-100/60",
    WARNING:
      "border border-yellow-500 text-yellow-700 bg-yellow-100/30 hover:bg-yellow-100/60",
    INFO: "border border-blue-500 text-blue-700 bg-blue-100/30 hover:bg-blue-100/60",
    DEBUG:
      "border border-green-500 text-green-700 bg-green-100/30 hover:bg-green-100/60",
    HEPSİ:
      "border border-gray-400 text-gray-700 bg-gray-100/30 hover:bg-gray-100/60",
  };
      ...
      {levels.map((level) => {
        ...
        return (
          <button
            ...
            className={`
              flex-1 text-center px-4 py-2 rounded-lg shadow
